...
trainNtest(model,x_train,y_train,x_test,y_test,meta,args['model_name'],batch_size=int(conf['batch_size']),ctc_train=False,fit_generator=fg, pretrain=args['pretrain'], n_epochs=args['n_epochs'])
